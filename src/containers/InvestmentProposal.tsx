...
const InvestmentProposal: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8 print:bg-white print:py-0">
      ...
      {/* DeFi Products */}
      <ProposalSection title={<><span className="text-sm text-gray-500">Appendix 1</span><br />DeFi 상품 기획</>} pageBreak>
        <DeFiProducts />
      </ProposalSection>

      {/* Stablecoin Strategy */}
      <ProposalSection title={<><span className="text-sm text-gray-500">Appendix 2</span><br />원화 스테이블 코인 출범 후 전략</>} pageBreak>
        <StablecoinStrategy />
      </ProposalSection>

      {/* Legal Risk Mitigation */}
      <ProposalSection title={<><span className="text-sm text-gray-500">Appendix 3</span><br />법적 리스크와 해소 전략</>} pageBreak>
        <LegalRiskMitigation />
      </ProposalSection>

      {/* Neo Partnership */}
      <ProposalSection title={<><span className="text-sm text-gray-500">Appendix 4</span><br />Neo 재단과의 전략적 파트너십</>} pageBreak>
        <NeoPartnership />
      </ProposalSection>
