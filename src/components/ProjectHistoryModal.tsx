    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-lg max-w-4xl w-full max-h-[90vh] overflow-y-auto">
        <div className="flex items-center justify-between p-6 border-b">
          <h2 className="text-2xl font-bold text-gray-800">주요 프로젝트 구축 이력</h2>
          <button
            onClick={onClose}
          ...
          <div className="space-y-6 text-sm">
            <div>
              ...
              <ul className="space-y-1 text-gray-600">
                ...
                <li>• 비트코인 UTXO 기반 암호화폐 지갑 개발 (<a href="https://play.google.com/store/apps/details?id=com.between.wallet" target="_blank" className="text-blue-600 hover:text-blue-800 underline">BetweenWallet</a>)</li>
              </ul>
            </div>
            <div>
