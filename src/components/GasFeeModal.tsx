      ...
      <div className="bg-white rounded-lg max-w-4xl w-full max-h-[90vh] overflow-y-auto">
        ...
        <div className="p-6">
          <div className="text-gray-700 leading-relaxed">
            ...
            <p className="mb-6">
              비트베이크는 한국의 규제를 준수하기 위해 비수탁형으로 운영되고 있습니다.<br/>
            ...
            <p className="mb-4">
              문제는 각 블록체인마다 가스비로 쓰이는 코인의 종류가 모두 다르다는 것입니다. (이더리움에서는 ETH, 솔라나에서는 SO, 네오에서는 GAS 등)
            </p>
            ...
            <p className="mb-6">
              하지만 대부분의 일반 사용자는 "가스비가 뭔지", "어떤 코인을 사야 하는지", "어디서 충전해야 하는지"조차 모릅니다.<br/>
              이 때문에 비수탁형 서비스의 진입장벽이 높아지고, "그냥 포기하거나 탈중앙화 서비스를 이용하지 않는 사용자"가 많습니다.
            </p>
            ...
            <p className="mb-4">
              ...
              사용자가 버튼만 누르면, 서비스가 대신 가스비를 내주고, 사용자는 마치 일반 앱처럼 간편하게 이용할 수 있습니다.
            </p>
