...
풀타임 인력 1명과 파트타임 또는 외주 인력 2명 수준으로 효율적인 팀 구조를 유지할 예정입니다.
      ...
      <div className="space-y-6">
        ...
        <div>
          ...
          <p className="text-gray-700 leading-relaxed">
            국내 리워드 앱 주요 기업(예: 캐시워크, 비트버니)은 시드 단계에서 50억 원 이상의 기업가치를 평가받았습니다. 비트베이크는 이들보다 더 다양한 수익 구조(DeFi + 리워드)와 원화 스테이블코인 및 DeFi 시장 선점 가능성을 동시에 보유하고 있습니다. 또한 초기 투자자가 과도한 지분을 확보함으로 인해 후속 투자가 어려워지는 문제를 고려하여 통상적으로 Seed Round 단계의 스타트업 기업가치는 20억 원에서 50억 원 사이로 책정됩니다. 따라서 16.6억 원의 밸류에이션은 보수적이면서도 충분히 합리적인 수준입니다.
          </p>
        </div>
      </div>
