      ...
      <div className="bg-white rounded-lg max-w-4xl w-full max-h-[90vh] overflow-y-auto">
        ...
        <div className="p-6">
          <div className="text-gray-700 leading-relaxed">
            ...
            <p className="mb-6">
              그리고 이 블록체인 위에는 수백 개의 '돈을 맡기고 이자를 받는 서비스(DeFi)'가 각각 따로 운영되고 있습니다.<br/>
            ...
            <div className="space-y-4 mb-6">
              ...
              <div>
                ...
                <p className="text-gray-700 ml-4">
                  이더리움은 ETH, 솔라나는 SOL, 네오는 GAS를 사용합니다. 마치 나라가 다르면 화폐가 다른 것처럼, 블록체인마다 자신의 블록체인을 이용하기 위한 기본 화폐가 제각각입니다.
                </p>
              </div>
            </div>
