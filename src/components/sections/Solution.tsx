...
이를 구현하기 위해서는 블록체인 생태계에 대한 깊은 이해와 기술력이 필수적이며, 이러한 역량을 갖춘 팀은 국내에서 찾아보기 어렵습니다.
      ...
      <p className="text-gray-700 leading-relaxed mb-4">
        비트베이크는 기프트카드를 통해 부분적으로 해결하고 있습니다. 유저는 상품권·기프티콘·교환권 등 기프트카드를 포인트로 교환한 뒤, 이를 암호화폐로 전환해 예치할 수 있습니다. 한국의 기프트카드 시장은 연간 약 8조 원 규모로, 사용되지 않고 남아 있는 미사용 카드도 상당합니다. 비트베이크는 이러한 기프트카드를 법정화폐를 대신한 실질적 지불수단으로 활용할 수 있게 하여 새로운 온램프 채널을 만들어냈습니다. 실제로 기프트카드를 판매해 USDT(테더)를 예치, 타 서비스에서 받은 리워드(기프트카드)를 비트베이크로 흡수하는 효과까지 확인했습니다.
      </p>
