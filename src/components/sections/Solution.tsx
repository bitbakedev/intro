...
이를 구현하기 위해서는 블록체인 생태계에 대한 깊은 이해와 기술력이 필수적이며, 이러한 역량을 갖춘 팀은 국내에서 찾아보기 어렵습니다.
      ...
      <p className="text-gray-700 leading-relaxed mb-4">
        비트베이크는 이러한 구조적 한계를 부분적으로라도 해결하기 위해 기프트카드(상품권, 기프티콘, 교환권 등)를 포인트로 교환하고 이를 암호화폐로 전환할 수 있는 서비스를 제공합니다. 약 8조 원 규모의 거대한 기프트카드 시장에는 사용하지 않고 남아있는 기프트카드가 상당하며, 비트베이크에서 이를 법정화폐를 대신한 지불수단으로 활용할 수 있습니다.
      </p>
