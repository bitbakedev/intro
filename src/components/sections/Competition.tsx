...
const Competition: React.FC = () => {
  ...
  return (
    <>
      ...
      <p className="text-gray-700 leading-relaxed mb-4">
        Pi Network는 이처럼 "리워드 기반 온보딩 모델을 통해 수천만 명 규모의 글로벌 유저 풀을 확보하고, 나아가 토큰 상장을 통한 경제적 가치 창출까지 연결할 수 있다"는 가능성을 입증한 사례라 할 수 있습니다. 반면에, 국내 리워드 앱들은 리워드 수단이 기프티콘이나 원화에 한정되어 있어 PiNetwork 와 같은 글로벌 확장이 사실상 불가능합니다.
      </p>
      
      <p className="text-gray-700 leading-relaxed mb-4">
         반면 비트베이크는 암호화폐를 직접 리워드로 지급하며, 더 나아가 이를 스테이킹으로 연계해 앱 유저의 자산을 락인(lock-in) 시키는 구조를 갖추고 있습니다. 이는 단순 리워드 지급을 넘어, 사용자 유지율과 플랫폼 성장성을 동시에 강화하는 강력한 경쟁력입니다.
      </p>
    </div>
