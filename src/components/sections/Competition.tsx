...
const Competition: React.FC = () => {
  return (
    <div className="prose prose-lg max-w-none">
      ...
      <p className="text-gray-700 leading-relaxed mb-8">
        한편, 업비트·빗썸 등 중앙화 거래소들은 국내에서 압도적인 점유율을 차지하고 있지만, 제도적 문제와 리스크, 수익성 층면에서 구조적으로 DeFi와 직접 연계될 수 없는 한계를 지니고 있습니다. 결국 이들이 제공할 수 있는 상품과 수익률에는 뚜렷한 한계가 있으며, 이는 DeFi 생태계의 본질적인 확장성과는 거리가 있습니다.
      </p>
