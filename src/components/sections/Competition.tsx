...
const Competition: React.FC = () => {
  ...
  return (
    <>
      ...
      <p className="text-gray-700 leading-relaxed mb-4">
        Pi Network는 이처럼 "리워드 기반 온보딩 모델을 통해 수천만 명 규모의 글로벌 유저 풀을 확보하고, 나아가 토큰 상장을 통한 경제적 가치 창출까지 연결할 수 있다"는 가능성을 입증한 사례라 할 수 있습니다. 반면에, 국내 리워드 앱들은 리워드 수단이 기프티콘이나 원화에 한정되어 있어 PiNetwork 와 같이 글로벌 확장성이 떨어집니다.
      </p>
