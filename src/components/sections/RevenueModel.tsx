...
현재보다 광고 효율과 수익성이 크게 향상될 전망입니다.
      ...
      <h3 className="text-lg sm:text-xl font-semibold text-gray-700 mb-4 ml-4">1. 스왑 & 출금 수수료</h3>
      
      <p className="text-gray-700 leading-relaxed mb-4 ml-6">
        사용자가 포인트를 암호화폐로 교환할 때 10% 서비스 수수료를 부과하며, 
        거래소로 출금 시에도 동일한 10% 서비스 수수료와 네트워크 수수료가 발생합니다. 
        이 구조는 사용자 자산이 늘어날수록 선형적으로 확대되는 안정적 수익원입니다.
      </p>
      
      <p className="text-gray-700 leading-relaxed mb-6 ml-6">
        향후 본격적인 포인트 ↔ 암호화폐 간 거래 기능을 구축하면 수수료율을 점진적으로 낮출 계획입니다. 
        다만, 현재 글로벌 암호화폐 거래소들 중 상당수가 0.5% 미만의 수수료율로도 높은 영업이익을 
        달성하고 있다는 점을 감안하면, 거래 수수료는 다른 리워드앱에서는 만들기 어려운 부가가치가 높은 
        비즈니스 구조임을 보여줍니다.
      </p>
      
      <h3 className="text-lg sm:text-xl font-semibold text-gray-700 mb-4 ml-4">2. 스테이킹 수익 수수료</h3>
      ...
      <p className="text-gray-700 leading-relaxed mb-6 ml-6">
        AUM 규모가 커질수록 비트베이크는 DeFi 서비스들과 협상을 통해 유동성을 집중적으로 제공하는 대가로 
      ...
      <h3 className="text-lg sm:text-xl font-semibold text-gray-700 mb-4 ml-4">3. B2B 마케팅</h3>
      ...
      <h2 className="text-xl sm:text-2xl font-bold text-gray-800 mb-6 mt-8">다양한 수익원의 상호 보완적 성장</h2>
