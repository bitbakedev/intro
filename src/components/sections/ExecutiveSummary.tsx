  ...
  return (
    <>
      ...
      <p className="text-gray-700 leading-relaxed mb-4">
        ...
        리워드로 받은 돈은 가벼운 마음으로 투자하지 않을까?"</strong>라는 가설로 시작되었습니다.
      </p>
      ...
      <p className="text-gray-700 leading-relaxed mb-4">
        리워드 앱 서비스 자체로 안정적인 수익화를 달성한 이후, 리워드를 암호화폐와 스테이킹 상품으로 적극적으로 전환시켜 DeFi 플랫폼으로 진화할 수 있습니다. 지난 3개월간의 실험을 통해 적극적인 노출 없이도 전체 리워드의 약 35%가 암호화폐 상품으로 전환되는 것을 확인했습니다.

      </p>
      <p className="text-gray-700 leading-relaxed mb-8">
        비트베이크는 투자유치 후 1년 내에 리워드앱 업계 초기 수준인 월 매출 15억을 달성하는것을 목표로 하고 있습니다. 이를 달성한다면 매월 약 5억 원이 암호화폐 상품에 예치되며, 1년 뒤에는 누적 예치금이 30~40억 원 규모로 성장할 것으로 예상합니다. 이로부터 발생하는 예치 및 스테이킹 수수료 수익은 일반적인 서비스나 광고 사업과는 비교할 수 없을 만큼 높은 수익성을 가집니다.
      </p>
      
      <p className="text-gray-700 leading-relaxed mb-8">
    기존 리워드 앱 서비스들은 스케일업 과정에서 수익성과 성장 한계에 부딪히고 있습니다. 그러나 비트베이크는 '리워드 앱에서 DeFi 플랫폼으로의 진화'라는 경쟁사들이 결코 따라오기 어려운 독창적인 성장 경로를 가지고 있습니다. 이는 단순히 광고 기반 수익 모델에 머무는 것이 아니라, 암호화폐 금융 이라는 고부가가치 사업으로 확장하는 전략입니다. 이는 기존 리워드 앱들이 쉽게 모방할 수 없는 비트베이크만의 압도적인 경쟁력이자 차별화 포인트입니다.
      </p>
      </div>
    </>
  );
