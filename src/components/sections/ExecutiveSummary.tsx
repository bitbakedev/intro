  ...
  return (
    <>
      ...
      <p className="text-gray-700 leading-relaxed mb-8">
        비트베이크는 투자유치 후 1년 내에 리워드앱 업계 초기 수준인 월 매출 15억을 달성하는것을 목표로 하고 있습니다. 이를 달성한다면 매월 약 5억 원이 암호화폐 상품에 예치되며, 1년 뒤에는 누적 예치금이 30~40억 원 규모로 성장할 것으로 예상합니다. 이러부터 발생하는 예치 및 스테이킹 수수료 수익은 일반적인 리워드 서비스나 광고 사업과는 비교할 수 없을 만큼 높은 수익성을 보이는 구조입니다.
      </p>
