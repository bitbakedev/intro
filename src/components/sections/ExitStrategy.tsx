        ...
        <table className="w-full border-collapse border border-gray-300">
          ...
          <tbody>
            ...
            <tr className="bg-gray-25">
              ...
              <td className="border border-gray-300 px-3 py-3 text-gray-700 text-sm align-top">회사가 일정 수준 이상의 영업이익(예: 연간 50억 이상 영업이익)을 달성하면, Seed 투자자의 지분을 사전에 약정된 가격(예: 투자액 대비 5배 가치)으로 되사줄 수 있는 옵션을 부여하는 것도 가능하며, 장기적으로는 IPO를 통해 증시에 상장 후 투자금을 회수하는 방안도 가능합니다.</td>
            </tr>
          </tbody>
        </table>
      </div>
