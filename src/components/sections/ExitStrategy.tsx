...
const ExitStrategy: React.FC = () => {
  return (
    <div className="prose prose-lg max-w-none">
      <p className="mb-5">투자자는 신규 투자자에게 구주 매각을 통해 Exit이 가능할 것으로 예상됩니다. Neo 블록체인 재단을 리드 투자사로 하여 자금적 지원뿐 아니라 블록체인 및 핀테크 관련 사업에 도움을 줄 수 있는 기관 투자사들을 대상으로 투자유치를 할 계획입니다.</p>
        ...
        <table className="w-full border-collapse border border-gray-300 min-w-[700px]">
          ...
          <tbody>
            ...
            <tr className="bg-gray-25">
              ...
              <td className="border border-gray-300 px-2 py-2 sm:px-3 sm:py-3 text-gray-700 align-top text-xs sm:text-sm">2027~2028</td>
              <td className="border border-gray-300 px-2 py-2 sm:px-3 sm:py-3 text-gray-700 align-top text-xs sm:text-sm">1,000억원 (62.5배)</td>
              <td className="border border-gray-300 px-2 py-2 sm:px-3 sm:py-3 text-gray-700 text-xs sm:text-sm align-top">밸류에이션 1,000억원을 목표로 하며, Seed 투자자는 70~80배의 수익률을 기대할 수 있습니다. 이 단계에서는 대형 VC나 재단들의 투자를 유치하여 글로벌 확장을 본격화할 예정입니다.</td>
            </tr>
            <tr>
              <td className="border border-gray-300 px-2 py-2 sm:px-3 sm:py-3 font-medium text-gray-800 align-top text-xs sm:text-sm">M&A</td>
              <td className="border border-gray-300 px-2 py-2 sm:px-3 sm:py-3 text-gray-700 align-top text-xs sm:text-sm">2027~2029</td>
              <td className="border border-gray-300 px-2 py-2 sm:px-3 sm:py-3 text-gray-700 align-top text-xs sm:text-sm">500~2,000억원 (30~125배)</td>
              <td className="border border-gray-300 px-2 py-2 sm:px-3 sm:py-3 text-gray-700 text-xs sm:text-sm align-top">밸류에이션 500-2,000억원 규모의 M&A를 통해 50-160배의 수익률을 달성할 수 있습니다. 토스, 카카오, 네이버 등이 잠재적인 인수사로 예상되며, 이들은 비트베이크의 Web3 기술력과 사용자 기반에 높은 가치를 부여할 것으로 전망됩니다.</td>
            </tr>
            <tr className="bg-gray-25">
              ...
              <td className="border border-gray-300 px-2 py-2 sm:px-3 sm:py-3 text-gray-700 text-xs sm:text-sm align-top">회사가 일정 수준 이상의 영업이익(예: 연간 20억 이상 영업이익)을 달성하면, Seed 투자자의 지분을 사전에 약정된 가격(예: 투자액 대비 5배 가치)으로 되사줄 수 있는 옵션을 부여하는 것도 가능합니다.<br/><br/>장기적으로는 IPO를 통해 증시에 상장 후 투자금을 회수하는 방안도 존재합니다.</td>
            </tr>
          </tbody>
        </table>
      </div>
