        ...
        <table className="w-full border-collapse border border-gray-300">
          <thead>
            <tr className="bg-gray-50">
              ...
              <th className="border border-gray-300 px-4 py-3 text-left font-semibold text-gray-800">밸류에이션 (수익률)</th>
          ...
          <tbody>
            <tr>
              ...
              <td className="border border-gray-300 px-4 py-3 text-gray-700">200~300억원 (15~20배)</td>
            ...
            <tr className="bg-gray-25">
              ...
              <td className="border border-gray-300 px-4 py-3 text-gray-700">1,000억원 (70~80배)</td>
            ...
            <tr>
              ...
              <td className="border border-gray-300 px-4 py-3 text-gray-700">500~2,000억원 (50~160배)</td>
            ...
            <tr className="bg-gray-25">
              ...
              <td className="border border-gray-300 px-4 py-3 text-gray-700">협의 (5배+)</td>
